/* npm t exercises/json/to_from_json_test.mjs
Instructions: implement to_from_json.mjs
*/
suite('to_from_json_test.mjs');

import * as assert from 'assert/strict';

import {Color, ColorPoint} from './to_from_json.mjs';
