/* npm t exercises/async-iteration/filter_async_iter_test.mjs
Instructions:
– Implement filter_async_iter.mjs
*/
suite('filter_async_iter_test.mjs');

import * as assert from 'assert/strict';

import { filterAsyncIter } from './filter_async_iter.mjs';
